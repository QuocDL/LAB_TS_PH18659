          ...
          <tbody>
            {productList.map((product, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 flex gap-[2px] items-center"><svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
